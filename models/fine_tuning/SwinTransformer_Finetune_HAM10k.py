...
# Load training and validation data-sets and pre-process the images

device = 'cuda' if torch.cuda.is_available() else 'cpu'
#model_checkpoint = "microsoft/swinv2-base-patch4-window12-192-22k" # Swin v2
model_checkpoint = "microsoft/swin-base-patch4-window7-224-in22k" # Swin 
batch_size = 16
n_epochs = 2
...
args = TrainingArguments(
    f"{model_name}-finetuned-HAM10k_NOCROP",
